...
public class AddRevisionToBOMDialog extends AbstractAIFDialog implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (btn.equals(okButton)) {
			if (itemID.getText() != null && !"".equals(itemID.getText())) {
				...
				AddRevisionToBOMOperation newFolderOperation;
				newFolderOperation = new AddRevisionToBOMOperation(app.getTargetComponent(), session, itemID.getText(),
						RevID.getText());
